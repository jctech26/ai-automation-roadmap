...
Qué es un servidor
Qué es un frontend y un backend
...
Aquí añadiré apuntes, capturas, ejemplos de JSON, pruebas con APIs o explicaciones propias.Fase 1: Alfabetización tecnológica
Objetivo
